...
|---|---|---|
| `scenarios/watchlist-baseline.js` | `app/watchlist/page.tsx` | 1 fetch for engagements + N parallel fetches for movie details (true 1+N) |
| `scenarios/movie-detail-baseline.js` | `app/movies/[id]/page.tsx` + `components/movie-actions.tsx` | 4 concurrent fetches when authed: movie + summary (SSR) + my-rating + in-watchlist (CSR) |
